...
//                    alertBuilder.setView(R.layout.ask_reminder_dialog);
                    ...
                    alertBuilder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            boolean ins =  helper.SAVENOTE(model , CallDate , model.getNote());
                            if(ins){
                                  Toast.makeText(EditNoteActivity.this, "Saved Without Reminder", Toast.LENGTH_LONG).show();
                            }
                            else{
    ...
    private void getTextData() {
        Cursor fetch = helper.GETNOTES( CallDate);
        if (fetch!=null) {
...
//                    alertBuilder.setView(R.layout.ask_reminder_dialog);
                    alertBuilder.setTitle("Do you wish to add a calendar event for this call?");
                    alertBuilder.setMessage("This will remind you about this call");
                    alertBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent toReminder = new Intent(EditNoteActivity.this , AddReminder.class);
