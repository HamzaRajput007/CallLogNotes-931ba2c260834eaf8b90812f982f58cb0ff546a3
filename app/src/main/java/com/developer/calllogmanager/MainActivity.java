...
import com.developer.calllogmanager.Models.ReminderModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Cursor cursor = helper.GetReminders();
        if(cursor.moveToFirst()){
            while (!cursor.isAfterLast()){
                hours = Integer.parseInt(cursor.getString(cursor.getColumnIndex("HOURS")) );
                minutes = Integer.parseInt(cursor.getString(cursor.getColumnIndex("MINUTES")) );
                dayOfMonth = Integer.parseInt(cursor.getString(cursor.getColumnIndex("DAY_OF_MONTH")) );
...
//                ampm = cursor.getString(cursor.getColumnIndex("AMPM"));

                reminderModel.setHours(hours);
                reminderModel.setDayOfMonth(dayOfMonth);
                reminderModel.setMinutes(minutes);
                reminderModel.setMonth(month);
                reminderModel.setYear(year);
                reminderModel.setAmpm(ampm);
            }
        }*/
